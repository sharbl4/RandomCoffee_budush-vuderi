...
export const bot = new Bot(Deno.env.get("BOT_TOKEN") || "7785377297:AAHQXYH32S0fE5TOZvuN1GPxxAnHOvT0OXg"); // export нужен, чтобы воспользоваться ботом в другом файле
